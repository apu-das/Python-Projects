...
####################### Description of the project #####################################
 ...
 # Let’s say User selected a range, i.e., from X to Y, where X and Y belong to Integer.
...
# Calculating minimum number of tries
...
while count < y:
    ...
    if guess == x:
        ...
        # Once the condition satisfies, the loop will break
        break
    elif guess < x:
